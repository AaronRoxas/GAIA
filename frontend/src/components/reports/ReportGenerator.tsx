        ...
        {currentStep === 'idle' && (
          <div className="grid gap-4 py-4">
            <div className="grid gap-2">
              <label htmlFor="report-title" className="text-sm font-medium dark:text-white text-gray-700">
                Report Title
              </label>
              <Input
                id="report-title"
            ...
            <div className="grid gap-2">
              <label htmlFor="generated-by" className="text-sm font-medium dark:text-white text-gray-700">
                Generated By
              </label>
              <Input
                id="generated-by"
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <label htmlFor="include-map" className="text-sm font-medium dark:text-white text-gray-700 cursor-pointer">
                Include map screenshot
              </label>
            </div>

            {/* Report Summary */}  
            <div className="p-3 bg-blue-50 dark:bg-primary dark:border-primary dark:text-white rounded-md border border-blue-200">
              <p className="text-sm font-semibold dark:text-white text-blue-900 mb-1">
                Report Summary
              </p>
              <p className="text-xs dark:text-white text-blue-700">
                <strong>{hazards.length}</strong> hazard{hazards.length !== 1 ? 's' : ''} will be included
              </p>
              {activeFilterCount > 0 && (
                <p className="text-xs dark:text-white text-blue-700 mt-1">
