      ...
      <div className="w-full max-w-screen-xl flex items-center justify-between gap-3">
        ...
        <nav className="flex items-center gap-3 sm:gap-[24px]">
          <Link
            ...
            className="bg-[#C75D00] text-white font-inter font-semibold text-[14px] sm:text-[16px] leading-[1.45] tracking-[-0.08px] px-[12px] sm:px-[16px] py-[8px] sm:py-[12px] rounded-[10px] sm:rounded-[12px] whitespace-nowrap transition-colors hover:bg-[#B85500] focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#0a2a4d]"
          >
            Report a Hazard
          </Link>
          <Link
            to="/track"
            className="font-inter font-medium text-[14px] sm:text-[16px] leading-[1.45] tracking-[-0.08px] text-[#0a2a4d] whitespace-nowrap transition-colors hover:text-[#005a9c] focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#005a9c]"
          >
            Track Report
          </Link>
          <Link
